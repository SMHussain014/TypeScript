...
let myFullName = 'I want to become a web developer';
let myFullNameArr = myFullName.split(' ');
...
let rawArr = [3, 5, 2, 0, 4, 1];
// Ascending Order of number type
let sortedArr = rawArr.sort((a, b) => (a - b));
console.log(sortedArr);
// Descending Order of number type
sortedArr = rawArr.sort((a, b) => (b - a));
console.log(sortedArr);
// Ascending Order of string type
let rawStringArr = ['Muhammad', 'Fatima', 'Ali', 'Hussain', 'Hassan'];
let sortedStringArr = rawStringArr.sort();
console.log(sortedStringArr);
// 15. Method - reverse()
// It change the order of an Array and returned modify Array
// Descending Order of string type
let reversedStringArr = rawStringArr.reverse();
...
// It does not modify the original Array
let filteredMyNumArr = myNumArr1.filter((element) => (element % 2 == 0));
...
// It does not modify the original Array
let squareMyNumArr = myNumArr1.map(element => element ** 2);
...
let fillMyNumArr = myNumArr1.fill(7, 2, 5);
...
let myFruits = ['Banana', 'Orange', 'Apple', 'Mango', 'Kiwi', 'Papaya'];
